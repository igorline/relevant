...
const statsFileName = NODE_ENV === 'production' ? 'loadable-stats' : 'loadable-stats-dev';
const statsFile = path.resolve(`app/public/dist/${statsFileName}.json`);

// This is the stats file generated by webpack loadable plugin
// We create an extractor from the statsFile
let extractor = NODE_ENV === 'production' ? new ChunkExtractor({ statsFile, entrypoints: 'app' }) : null;
