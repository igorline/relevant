...
const Tag = require('../api/tag/tag.model');
...
const Statistics = require('../api/statistics/statistics.model');
const Earnings = require('../api/earnings/earnings.model');
const Message = require('../api/message/message.model');
const Relevance = require('../api/relevance/relevance.model');
const Treasury = require('../api/treasury/treasury.model');
const MetaPost = require('../api/metaPost/metaPost.model');
