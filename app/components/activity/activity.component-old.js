...
export default function (props) {
  ...
  let renderPost = (post) => {
    if (!post) return null;
    let link = props.posts.links[post.metaPost];
    let previewProps = { urlPreview: link || post };
    return (
  ...
  let getText = () => {
    ...
    let type = singleActivity.post ? singleActivity.post.type : 'post';
    ...
    switch (singleActivity.type) {
      case 'upvote':
        ...
        return (
          <Text style={styles.activityText}>
            {renderName(singleActivity.byUser)} upvoted your {type} → {coinText}your relevance increased by {amount}
          </Text>
        );
      ...
      case 'downvote':
        return (
          <Text style={styles.activityText}>
            {renderName(singleActivity.byUser)} downvoted your {type} → your relevance decreased by {amount}
          </Text>
        );
      ...
      case 'partialUpvote':
        return (
          <Text style={styles.activityText}>
            {renderName(singleActivity.byUser)} {also}upvoted this {type} → your relevance {action} by {amount}
          </Text>
        );
      ...
      case 'partialDownvote':
        return (
          <Text style={styles.activityText}>
            {renderName(singleActivity.byUser)} {also}downvoted this {type} → your relevance {action} by {amount}
          </Text>
        );
