...
How it works:
            ...
            <ul>
              ...
              >
                <row>
                  <span>User reputation and ranking content</span>
                  <marrow><img src={'/img/blackarrow.png'}/></marrow>
                </row>
                <div>
                  <p>
              ...
              >
                ...
                <div>
                  <p>
                    The user is not the center of the Relevant universe — information is. What you see is not filtered by who you know or how you feel — but what is most salient on the platform as a whole. Everyone sees the same feed and users are exposed to a variety of viewpoints and opinions. The feed is a result of communal curation and not your personal preferences. 
                  </p>
                </div>
              </li>
              ...
              >
                ...
                <div>
                  <p>
                    Binary feedback is not sufficient to distinguish between the nuanced array of responses we have to what we see online. At Relevant, we are actively developing feedback options beyond upvotes and downvotes that will produce more valuable differentiations between information.
                  </p>
                </div>
              </li>
            </ul>
...
At Relevant, we envision a democratic and transparent platform that allows engaged experts to participate in the creation of a global knowledge project while providing readers with the best discovery tool on the market.
            ...
            <p>
Our goal is to filter out the noise from the information environment and we need your help. Early adopters are crucial in shaping the Relevant metric and are the most likely to reap the rewards of the Relevant economy. 
            </p>
{/*
            <p>
...
Discover great content.
            ...
            <p>
Sign up now to contribute to the Relevant knowledge project, earn Relevant Tokens and discover quality content.
            </p>
