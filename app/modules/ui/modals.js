...
// const rIcon = require('app/public/img/r-emoji.png');
...
export const onboarding = {
  ...
  body: <View>
    <ImageWrapper mt={6}>
      <Image resizeMode={'contain'} w={2.8} h={2.8} mr={0.75} source={require('app/public/img/r-emoji.png')}/>
      <Title >Build Trust</Title>
    </ImageWrapper>
    <Text fs={1.75} mt={1}>
      Boost your Reputation by posting quality comments. The most reputable users become community leaders.
    </Text>
  ...
  footer: props => <View align={'flex-start'} mt={3}>
