...
//           self.setState({
//             messagesData: self.state.messagesData.cloneWithRows(
//               self.props.messages.index
//             )
//           });
//         }
//       }
...
//       self.setState({
//         messagesData: self.state.messagesData.cloneWithRows(next.messages.index)
//       });
//     }
//   }
...
//         >
//           <Text style={[{ fontWeight: '500' }, styles.darkGrey]}>
//             No messages bruh
//           </Text>
//         </View>
//       );
...
//     return (
//       <View style={{ flex: 1, backgroundColor: 'white' }}>{messagesEl}</View>
//     );
//   }
// }
