...
class CreatePostContainer extends Component {
  ...
  renderScene() {
    switch (this.props.step) {
      case 'url':
        return <UrlComponent share {...this.props.createPost} actions={this.props.actions} />;
      case 'categories':
        return <Categories share {...this.props.createPost} actions={this.props.actions} />;
      case 'post':
        return <CreatePostComponent share {...this.props.createPost} actions={this.props.actions} />;
